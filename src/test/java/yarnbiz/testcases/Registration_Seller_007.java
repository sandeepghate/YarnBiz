...
public class Registration_Seller_007 extends ListenerClass{
...
****************************************************************************************************/
	...
	@Test
	public void Registration_Seller_007() throws InterruptedException
	{		
		rp.NewSeller();
		...
		driver.findElement(By.xpath("//button[@class='send_otp action primary']")).click();
		 driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);	       
        Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='otp']")).sendKeys("5050");
